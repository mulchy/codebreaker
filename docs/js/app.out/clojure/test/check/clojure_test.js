...
clojure.test.check.clojure_test.assert_check = (function clojure$test$check$clojure_test$assert_check(p__15875){
var map__15879 = p__15875;
...
var m = map__15879__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15879__$1,cljs.core.cst$kw$result);
cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([m], 0));

if(cljs.core.truth_(clojure.test.check.impl.exception_like_QMARK_(result))){
throw result;
} else {
try{var value__15579__auto__ = result;
if(cljs.core.truth_(value__15579__auto__)){
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$pass,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__15579__auto__,cljs.core.cst$kw$message,null], null));
} else {
cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$fail,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,value__15579__auto__,cljs.core.cst$kw$message,null], null));
}

return value__15579__auto__;
}catch (e15881){var t__15614__auto__ = e15881;
return cljs.test.do_report(new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$type,cljs.core.cst$kw$error,cljs.core.cst$kw$expected,cljs.core.cst$sym$result,cljs.core.cst$kw$actual,t__15614__auto__,cljs.core.cst$kw$message,null], null));
}}
});
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Invalid defspec options: "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([options], 0)))].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$bad_DASH_options,options], null));
...
clojure.test.check.clojure_test.last_trial_report = (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1((0)) : cljs.core.atom.call(null,(0)));
var begin_test_var_method_15885 = cljs.core.get_method(cljs.test.report,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test_DASH_var], null));
cljs.test.report.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$cljs$test_SLASH_default,cljs.core.cst$kw$begin_DASH_test], null),((function (begin_test_var_method_15885){
return (function (m){
var G__15883_15886 = clojure.test.check.clojure_test.last_trial_report;
var G__15884_15887 = clojure.test.check.impl.get_current_time_millis();
(cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__15883_15886,G__15884_15887) : cljs.core.reset_BANG_.call(null,G__15883_15886,G__15884_15887));

if(cljs.core.truth_(begin_test_var_method_15885)){
return (begin_test_var_method_15885.cljs$core$IFn$_invoke$arity$1 ? begin_test_var_method_15885.cljs$core$IFn$_invoke$arity$1(m) : begin_test_var_method_15885.call(null,m));
} else {
return null;
}
});})(begin_test_var_method_15885))
);
clojure.test.check.clojure_test.get_property_name = (function clojure$test$check$clojure_test$get_property_name(p__15888){
var map__15891 = p__15888;
var map__15891__$1 = ((((!((map__15891 == null)))?((((map__15891.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15891.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__15891):map__15891);
var report_map = map__15891__$1;
var property_fun = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15891__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_property);
var or__7393__auto__ = cljs.core.cst$kw$name.cljs$core$IFn$_invoke$arity$1(cljs.core.meta(property_fun));
...
if(((t - clojure.test.check.clojure_test._STAR_trial_report_period_STAR_) > (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(clojure.test.check.clojure_test.last_trial_report) : cljs.core.deref.call(null,clojure.test.check.clojure_test.last_trial_report)))){
clojure.test.check.clojure_test.with_test_out_STAR_(((function (t){
return (function (){
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["Passing trial",cljs.core.first(cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_trial.cljs$core$IFn$_invoke$arity$1(m)),"/",cljs.core.second(cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_trial.cljs$core$IFn$_invoke$arity$1(m)),"for",clojure.test.check.clojure_test.get_property_name(m)], 0));
});})(t))
);

return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(clojure.test.check.clojure_test.last_trial_report,t) : cljs.core.reset_BANG_.call(null,clojure.test.check.clojure_test.last_trial_report,t));
} else {
return null;
}
});
 ...
 */
clojure.test.check.clojure_test.trial_report_dots = (function clojure$test$check$clojure_test$trial_report_dots(p__15893){
var map__15899 = p__15893;
...
var vec__15900 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15899__$1,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_trial);
var so_far = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15900,(0),null);
var total = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15900,(1),null);
if((so_far > (0))){
if((cljs.core.mod(so_far,(1000)) === (0))){
cljs.core.print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["."], 0));
...
var temp__6753__auto__ = (function (){var and__7381__auto__ = clojure.test.check.clojure_test._STAR_report_trials_STAR_;
...
var trial_report_fn = temp__6753__auto__;
...
return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq(["Shrinking",clojure.test.check.clojure_test.get_property_name(m),"starting with parameters",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_params.cljs$core$IFn$_invoke$arity$1(m)], 0))], 0));
}));
} else {
return null;
}
...
var G__15907 = new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$type,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_shrinking,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_property,property_fun,cljs.core.cst$kw$clojure$test$check$clojure_DASH_test_SLASH_params,cljs.core.vec(failing_params)], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__15907) : cljs.test.report.call(null,G__15907));
});
