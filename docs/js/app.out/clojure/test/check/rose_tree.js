...
clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__8045__auto__,writer__8046__auto__,opt__8047__auto__){
return cljs.core._write(writer__8046__auto__,"clojure.test.check.rose-tree/RoseTree");
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__16494 = (n - (1));
var G__16495 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__16494,G__16495) : clojure.test.check.rose_tree.exclude_nth.call(null,G__16494,G__16495));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__16498 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__16498) : f.call(null,G__16498));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16496_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__16496_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__16496_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16499_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__16499_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__16499_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__16500_SHARP_){
var G__16502 = clojure.test.check.rose_tree.root(p1__16500_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__16502) : pred.call(null,G__16502));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__8250__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__16520(s__16521){
return (new cljs.core.LazySeq(null,(function (){
var s__16521__$1 = s__16521;
while(true){
var temp__6753__auto__ = cljs.core.seq(s__16521__$1);
if(temp__6753__auto__){
var xs__7309__auto__ = temp__6753__auto__;
var vec__16532 = cljs.core.first(xs__7309__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16532,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16532,(1),null);
var iterys__8246__auto__ = ((function (s__16521__$1,vec__16532,rose,index,xs__7309__auto__,temp__6753__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__16520_$_iter__16522(s__16523){
return (new cljs.core.LazySeq(null,((function (s__16521__$1,vec__16532,rose,index,xs__7309__auto__,temp__6753__auto__){
return (function (){
var s__16523__$1 = s__16523;
while(true){
var temp__6753__auto____$1 = cljs.core.seq(s__16523__$1);
if(temp__6753__auto____$1){
var s__16523__$2 = temp__6753__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__16523__$2)){
var c__8248__auto__ = cljs.core.chunk_first(s__16523__$2);
var size__8249__auto__ = cljs.core.count(c__8248__auto__);
var b__16525 = cljs.core.chunk_buffer(size__8249__auto__);
if((function (){var i__16524 = (0);
while(true){
if((i__16524 < size__8249__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__8248__auto__,i__16524);
cljs.core.chunk_append(b__16525,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__16537 = (i__16524 + (1));
i__16524 = G__16537;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16525),clojure$test$check$rose_tree$permutations_$_iter__16520_$_iter__16522(cljs.core.chunk_rest(s__16523__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16525),null);
}
} else {
var child = cljs.core.first(s__16523__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__16520_$_iter__16522(cljs.core.rest(s__16523__$2)));
}
} else {
return null;
}
...
});})(s__16521__$1,vec__16532,rose,index,xs__7309__auto__,temp__6753__auto__))
,null,null));
});})(s__16521__$1,vec__16532,rose,index,xs__7309__auto__,temp__6753__auto__))
;
var fs__8247__auto__ = cljs.core.seq(iterys__8246__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__8247__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__8247__auto__,clojure$test$check$rose_tree$permutations_$_iter__16520(cljs.core.rest(s__16521__$1)));
} else {
var G__16538 = cljs.core.rest(s__16521__$1);
s__16521__$1 = G__16538;
continue;
}
} else {
return null;
...
return iter__8250__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16539_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__16539_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__16539_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16540_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__16540_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__16540_SHARP_));
...
return cljs.core.cons(node,((cljs.core.seq(the_children))?clojure$test$check$rose_tree$seq_$_helper(cljs.core.first(the_children),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(seen,node),clojure.test.check.rose_tree.make_stack(cljs.core.rest(the_children),stack)):(function (){var temp__6753__auto__ = cljs.core.seq(stack);
if(temp__6753__auto__){
var s = temp__6753__auto__;
...
var temp__6753__auto__ = cljs.core.seq(stack);
if(temp__6753__auto__){
var s = temp__6753__auto__;
var f = cljs.core.ffirst(s);
var r = cljs.core.rest(cljs.core.first(s));
