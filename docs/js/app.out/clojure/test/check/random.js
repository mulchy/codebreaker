...
var x__8106__auto__ = (((rng == null))?null:rng);
var m__8107__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__8106__auto__)]);
if(!((m__8107__auto__ == null))){
return (m__8107__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto__.call(null,rng));
} else {
var m__8107__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if(!((m__8107__auto____$1 == null))){
return (m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto____$1.call(null,rng));
} else {
...
var x__8106__auto__ = (((rng == null))?null:rng);
var m__8107__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__8106__auto__)]);
if(!((m__8107__auto__ == null))){
return (m__8107__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto__.call(null,rng));
} else {
var m__8107__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if(!((m__8107__auto____$1 == null))){
return (m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto____$1.call(null,rng));
} else {
...
var x__8106__auto__ = (((rng == null))?null:rng);
var m__8107__auto__ = (clojure.test.check.random.split[goog.typeOf(x__8106__auto__)]);
if(!((m__8107__auto__ == null))){
return (m__8107__auto__.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto__.call(null,rng));
} else {
var m__8107__auto____$1 = (clojure.test.check.random.split["_"]);
if(!((m__8107__auto____$1 == null))){
return (m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__8107__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__8107__auto____$1.call(null,rng));
} else {
...
var x__8106__auto__ = (((rng == null))?null:rng);
var m__8107__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__8106__auto__)]);
if(!((m__8107__auto__ == null))){
return (m__8107__auto__.cljs$core$IFn$_invoke$arity$2 ? m__8107__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8107__auto__.call(null,rng,n));
} else {
var m__8107__auto____$1 = (clojure.test.check.random.split_n["_"]);
if(!((m__8107__auto____$1 == null))){
return (m__8107__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__8107__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__8107__auto____$1.call(null,rng,n));
} else {
...
var G__16947 = z;
if(((24) > (function (){var G__16948 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__16948) : clojure.test.check.random.longs.bit_count.call(null,G__16948));
})())){
return clojure.test.check.random.longs.bit_xor(G__16947,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__16947;
}
});
...
var G__16951 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__16952 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__16951;
ret = G__16952;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__8045__auto__,writer__8046__auto__,opt__8047__auto__){
return cljs.core._write(writer__8046__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__7393__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
clojure.test.check.random.next_rng = (function (){var a = (function (){var G__16953 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$state,clojure.test.check.random.make_java_util_splittable_random((new Date()).valueOf())], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__16953) : cljs.core.atom.call(null,G__16953));
})();
return ((function (a){
return (function (){
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16955__$1,cljs.core.cst$kw$state);
var vec__16957 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16957,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16957,(1),null);
...
var args16960 = [];
var len__8609__auto___16963 = arguments.length;
var i__8610__auto___16964 = (0);
while(true){
if((i__8610__auto___16964 < len__8609__auto___16963)){
args16960.push((arguments[i__8610__auto___16964]));

var G__16965 = (i__8610__auto___16964 + (1));
i__8610__auto___16964 = G__16965;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args16960.length)].join('')));
