...
if((i < len)){
var k = (ks[i]);
var G__16338 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__16339 = (i + (1));
m = G__16338;
i = G__16339;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__16343 = c;
var G__16343__$1 = (((G__16343 == null))?null:G__16343.prototype);
if((G__16343__$1 == null)){
return null;
} else {
return (G__16343__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__16347 = c;
var G__16347__$1 = (((G__16347 == null))?null:G__16347.prototype);
if((G__16347__$1 == null)){
return null;
} else {
return (G__16347__$1["render"]);
}
})()));
});
...
return (function() { 
var G__16353__delegate = function (args){
var G__16351 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__16351) : reagent.impl.component.as_element.call(null,G__16351));
};
var G__16353 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__16354__i = 0, G__16354__a = new Array(arguments.length -  0);
while (G__16354__i < G__16354__a.length) {G__16354__a[G__16354__i] = arguments[G__16354__i + 0]; ++G__16354__i;}
  args = new cljs.core.IndexedSeq(G__16354__a,0);
} 
return G__16353__delegate.call(this,args);};
G__16353.cljs$lang$maxFixedArity = 0;
G__16353.cljs$lang$applyTo = (function (arglist__16355){
var args = cljs.core.seq(arglist__16355);
return G__16353__delegate(args);
});
...
var _STAR_current_component_STAR_16358 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_16358;
}});
...
var G__16366 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__16366) {
...
return ((function (G__16366){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__16369 = reagent.impl.component.state_atom(c);
var G__16370 = f.call(c,c);
...
var or__7393__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__16372_16374 = (c["cljsRatom"]);
if((G__16372_16374 == null)){
} else {
reagent.ratom.dispose_BANG_(G__16372_16374);
}
...
if(cljs.core.truth_((function (){var and__7381__auto__ = wrap;
...
var renders_16377 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_16378 = cljs.core.first(cljs.core.vals(renders_16377));
if((cljs.core.count(renders_16377) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_16377))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_16378)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_16378], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__7393__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7393__auto__)){
return or__7393__auto__;
} else {
...
var render_fun__$1 = (function (){var or__7393__auto__ = render_fun;
if(cljs.core.truth_(or__7393__auto__)){
return or__7393__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__7393__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7393__auto__)){
return or__7393__auto__;
} else {
...
var name__$1 = (function (){var G__16376 = name;
switch (G__16376) {
case "":
...
var elem = (function (){var G__16387 = (function (){var or__7393__auto__ = (function (){var G__16389 = c;
if((G__16389 == null)){
return null;
} else {
return (G__16389["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7393__auto__)){
return or__7393__auto__;
...
return (G__16387["_currentElement"]);
}
})();
var name = (function (){var G__16390 = elem;
var G__16390__$1 = (((G__16390 == null))?null:(G__16390["type"]));
if((G__16390__$1 == null)){
return null;
} else {
return (G__16390__$1["displayName"]);
}
})();
var path = (function (){var G__16391 = elem;
var G__16391__$1 = (((G__16391 == null))?null:(G__16391["_owner"]));
var G__16391__$2 = (((G__16391__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__16391__$1) : reagent.impl.component.component_path.call(null,G__16391__$1)));
if((G__16391__$2 == null)){
return null;
} else {
return [cljs.core.str(G__16391__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__7393__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__7393__auto__)){
return or__7393__auto__;
} else {
var G__16393 = c;
var G__16393__$1 = (((G__16393 == null))?null:G__16393.constructor);
if((G__16393__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__16393__$1);
}
}
})();
